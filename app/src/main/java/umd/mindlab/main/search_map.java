...
public class search_map extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean permissionCheck = ContextCompat.checkSelfPermission(search_map.this, permission[0]) ==
                PackageManager.PERMISSION_GRANTED;

        if (!permissionCheck) {
            // If permissions are not already granted, request permission from the user.
            ActivityCompat.requestPermissions(search_map.this, permission, requestCode);
    ...
    private void setSearchView() {
        ...
        mSearchview.setQueryHint("Enter address");
    ...
    private void setUpOfflineMapGeocoding() {
        ...
        TileCache tileCache = new TileCache(extern + "/streetmap_SD.tpk");
...
//        mLocatorTask = new LocatorTask(extern + getResources().getString(R.string.sandiego_loc));
                            ...
                            try {
                                ...
                                if (geocodeResults.size() > 0) {
                                    ...
                                    Toast.makeText(getApplicationContext(),
                                            "We are sorry, we couldn\\'t find a location with the name -" + address,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(search_map.this, "Storage permission denied", Toast
                    .LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        if (!graphic.isEmpty()) {
                            ...
                            if (!isPinSelected) {
                                ...
                                Toast.makeText(getApplicationContext(),
                                        "Drag the pin to reverse-geocode",
